...
public class LineSegment {
    ...
    public LineSegment(Point p, Point q) {
        if (p == null || q == null) {
            throw new IllegalArgumentException("argument to LinearSegment constructor is null");
        }
        if (p.equals(q)) {
            throw new IllegalArgumentException("both arguments to LinearSegment constructor are the same point: " + p);
        }
        this.p = p;
        this.q = q;
    }
